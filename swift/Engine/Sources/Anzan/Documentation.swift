...
extension Calculator {
    ...
    static let operators: [FunctionDoc] = [
        ...
        FunctionDoc(
            name: "degrees",
            signature: "x°",
            summary: "Postfix degrees→radians: x° is x × π/180 (π at the engine's 50-digit precision), so sin(90°) = 1. Works in every mode, chains like % (A:1°, (a + b)°). The trig functions themselves always take radians — ° is how you hand them degrees.",
            examples: ["sin(90°)", "cos(180°)", "90° == pi / 2"]),
        FunctionDoc(
            name: "strings",
            signature: "\"text\"   ·   +",
        ...
        FunctionDoc(
            name: "modes",
            signature: ":mode normal · programmer · scientific [eng]",
